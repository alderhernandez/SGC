...
<script type="text/javascript">
    ...
    function editar(id)
    {
       location.href = "<?php echo base_url('index.php/editarArticulo/') ?>"+id;
    }
    ...
    function Baja(id,estado)
    {
        let message = '', text = '';
        if(estado == "1"){
            message = 'Se dará de baja el este artículo, no se reflejara en los reportes.'+
                '¿Desea continuar?';
            text = 'Dar baja';
        }else{
            message= '¿Desea restaurar el artículo ?';
            text = "Restaurar";
        }
        Swal.fire({
            text: message,
