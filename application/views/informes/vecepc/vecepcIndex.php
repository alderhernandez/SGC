<div class="content-wrapper">
    <section class="content-header">
        <h2>
            Verificacion especificaciones de calidad de elaboracion de productos cocinados

            <a href="<?php echo base_url("index.php/nuevoVecepc")?>" class="pull-right btn btn-primary">
