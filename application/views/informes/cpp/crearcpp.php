			...
			<div class="box-body">
					<div class="row">
						<!--<div class="col-xs-12">-->
							...
							<div class="col-dx-12 col-sm-3 col-md-2 col-lg-3">
								<div class="form-group has-feedback">
							...
							<div class="col-dx-12 col-sm-3 col-md-2 col-lg-2">
								<div class="form-group has-feedback">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="col-dx-12 col-sm-3 col-md-2 col-lg-2" style="display: none;">
