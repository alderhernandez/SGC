                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-3 col-sm-4 col-md-3 col-lg-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="hidden" name="" id="idUser" class=""
                                 ...
                                 foreach($detalle as $key){
                                     echo "
                                        <tr>
                                            ...
                                            <td>".$key["PesoCajillaVacia"]."</td>
                                            <td>".$key["PesoPromUnidad"]."</td>
                                            <td>".$key["CantidadTotalUnidades"]."</td>
                                            <td>".$key["PorcentajeRendimiento"]."</td>
                                            <td>".$key["PorcentajeMerma"]."</td>
