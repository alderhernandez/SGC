 ...
 * User: Sistemas
 * Date: 14/10/2019 11:52 2019
 * FileName: crearEepdc.php
 */
?>
<div class="content-wrapper">
    <section class="content-header">
        ...
        <h4 class="text-center">
            <span id="nombreRpt">EVALUACION DE ENVASES PARA DOBLE CIERRE</span>
        </h4>
        <h4 class="text-center">
            <?php
            if(!$version){
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                            <p class="text-bold">L: <span id="spanL">0</span></p>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                            <p class="text-bold">GC: <span id="spanGC">0</span></p>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                            <p class="text-bold">GT: <span id="spanGT">0</span></p>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                            <p class="text-bold">T: <span id="spanT">0</span></p>
                        </div>
                      </div>
                    </div>
                </div>
