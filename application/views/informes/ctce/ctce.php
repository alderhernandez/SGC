...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			CONTROL DE TEMPERATURAS DE CONTENEDORES EXTERNOS (CTCE)

			<a href="<?php echo base_url("index.php/nuevoctce")?>" class="pull-right btn btn-primary">
											...
											if($key["ESTADO"] == "A"){
												echo "
													<td class='text-center'>
													    <a class='detalles btn btn-success btn-xs' href='".base_url("index.php/verCTCE/".$key["IDREPORTE"]."")."'>
														  <i class='fa fa-eye'></i>
														</a>
														<a class='btn btn-primary btn-xs' href='".base_url("index.php/editarCTCE/".$key["IDREPORTE"]."")."'>
