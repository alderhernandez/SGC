	...
	<section class="content">
		<div class="box box-danger">
			<div class="box-header with-border">
				...
				<a href="<?php echo base_url("index.php/imprimirCTCE/".$enc[0]["IDREPORTE"]."")?>" target="_blank" class="pull-right btn btn-primary">
					...
					<div class="row">
							<div class="col-xs-3 col-sm-3 col-md-2 col-lg-3">
								<div class="form-group has-feedback">
									...
									<input autocomplete="off" type="text" disabled id="fecha" value="<?php echo $enc[0]["FECHACREA"] ?>"  class="form-control" placeholder="Fecha ingreso">
							...
							<div class="col-xs-8 col-sm-6 col-md-6 col-lg-4">
								<div class="form-group has-feedback">
									...
									<input autocomplete="off" type="text" id="observacionGeneral" value="<?php echo $enc[0]["OBSERVACIONES"] ?>"  disabled class="form-control" placeholder="Observaciones">
