...
<div class="content-wrapper">
	<table class="table-produccion">
			...
			<tr>
				<td class="encabezado" colspan="13">CONTROL DE DIAMETRO EN PROCESO<br>
				<?php
				if(!$det){
					}else{
			...
			<tr>
				<td colspan="1" class="negrita ">FUNDA:</td>
				<td colspan="7">
					<?php echo number_format($enc[0]["FUNDALARGO"],0) ?> x <?php echo number_format($enc[0]["FUNDADIAMETRO"],0) ?>
				</td>
			</tr>
			<tr>
				<td colspan="1" class="negrita ">MUESTRA:</td>
				<td colspan="7">
					<?php echo number_format($enc[0]["MUESTRA"],0) ?>
				</td>
			</tr>
			<tr>
				<td colspan="1" class="negrita ">DECISION:</td>
				<td colspan="7">
					<?php echo $enc[0]["DECISION"] ?>
				</td>
			</tr>
			</thead>
			<tbody>
