	...
	<section class="content">
		<div class="box box-danger">
			<div class="box-header with-border">
				...
				<a href="<?php echo base_url("index.php/imprimirCPP2/".$enc[0]["IDREPORTE"]."")?>" target="_blank" class="pull-right btn btn-primary">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-xs-4 col-sm-3 col-md-2 col-lg-3">
								<div class="form-group">
									<label>Máquina</label>
									<select id="ddlMaquina" disabled="true" class="form-control select2" style="width: 100%;">
										<option></option>
										<?php 
											if(!$maq){
											}else{
												foreach ($maq as $key) {
													if ($enc[0]["IDMAQUINA"] == $key["IDMAQUINA"]) {
														echo "<option selected value='".$key["IDMAQUINA"]."'>".$key["MAQUINA"]."</option>";
													}
												}
											}
										?>
							...
							<div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
								<div class="form-group has-feedback">
									...
									<input autofocus="" autocomplete="off" type="text" id="largo" value="<?php echo $enc[0]["FUNDALARGO"] ?>" class="form-control col-xs-2" placeholder="largo">
									<span class="fa fa-sort-alpha-desc form-control-feedback"></span>									
								</div>
							</div>
							<div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
								<div class="form-group has-feedback">
									<label for="">Funda</label>
									<input autofocus="" autocomplete="off" type="text" id="diametro" value="<?php echo $enc[0]["FUNDADIAMETRO"] ?>" class="form-control col-xs-2" placeholder="diametro">
									<span class="fa fa-sort-alpha-desc form-control-feedback"></span>
								</div>
							</div>							
							<div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
								<div class="form-group ">
									...
									<input disabled="true"  value="<?php echo $enc[0]["NOBATCH"] ?>" autocomplete="off" type="text" id="batch" class="form-control" placeholder="Batch">
									<span class="fa fa-sort-alpha-desc form-control-feedback"></span>
								</div>
							</div>
							<div id="checkboxes" class="col-lg-12 form-check form-check-inline">
								<?php $dictamen = array('Aceptar','Rechazar','Reclasificar','Desechar','Otras'); 
									$checked = '';
									foreach ($dictamen as $key) {
										if ($key== $enc[0]["DECISION"]) {
											$checked = 'checked="true"';
										}
										echo '<label class="form-check-label" for="chk'.$key.'">'.$key.'</label>
								 	 		<input class="form-check-input" '.$checked.' type="radio" name="inlineRadioOptions" id="chk'.$key.'" value="'.$key.'">';
								 	 	$checked = '';
									}
								?>
							</div>
