<div class="content-wrapper">
    <section class="content-header">
        <h2>
            VERIFICACION DEL PCC No. 2 CONTROL DE HORNO AHUMADOS

            <a href="<?php echo base_url("index.php/nuevoCdha")?>" class="pull-right btn btn-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <table id="tblCdha" class="table table-bordered table-condensed table-striped display nowrap">
                            <thead class="text-sm">
                                <tr>
                                    <th>Consecutivo</th>
                                    <th>Area</th>
