 ...
 * User: Sistemas
 * Date: 14/11/2019 14:02 2019
 * FileName: editarCdt.php
 */
?>
                            ...
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group has-feedback">
                                    ...
                                    if(!$detalle){
                                        ...
                                        echo '<input value="'.$key["VERSION"].'" autocomplete="off" type="text" id="version" class="form-control" placeholder="Version del informe">';
                                    }
                                    ?>
                            ...
                            <div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
                                <div class="form-group has-feedback">
                                    ...
                                    if(!$detalle){
                                        ...
                                        echo '<input value="'.$key["LOTE"].'" autocomplete="off" type="text" id="Lote" class="form-control" placeholder="">';
                                    }
                                    ?>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" id="Verificacion" class="form-control" placeholder="">
                                    <span class="fa fa-pencil form-control-feedback"></span>
                                </div>
                            </div>
